...
function Banner() {
  ...
  <div className="hero-content text-center text-neutral-content">
    <div className="max-w-md">
      ...
      <p className="mb-5 text-2xl">Anime Events is your premier destination for all things anime, where we specialize in curating unforgettable events that celebrate this dynamic and captivating art form. Let&apos;s dive into world of anime.</p>
